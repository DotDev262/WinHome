# WinHome Configuration (`config.yaml`)

This document outlines the various configuration modules available in WinHome. You can define your desired state in a `config.yaml` file, and WinHome will apply it.
