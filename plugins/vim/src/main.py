...
def apply_config(config, context):
    # config is the raw dictionary from yaml, e.g. { "number": true, "theme": "gruvbox" }
    ...
    # Simple recursive generator or just flat handling
    # Handling "settings" key specifically if present, otherwise flat
