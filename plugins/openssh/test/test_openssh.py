...
"""
        blocks = plugin.parse_ssh_config(text)
    ...
    def test_merge_settings_new_global(self):
        blocks = plugin.parse_ssh_config("UseKeychain yes\n")
        args = {
            "global": {
                "AddKeysToAgent": "yes",
                "UseKeychain": "no"
