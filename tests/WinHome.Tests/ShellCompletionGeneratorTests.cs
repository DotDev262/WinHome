...
{
    /// <summary>Helper to build a minimal RootCommand matching the WinHome CLI structure.</summary>
    ...
    [Fact]
    public void Generate_PowerShell_ContainsRegisterArgumentCompleter()
    {
        var root = BuildTestRootCommand();
        var script = ShellCompletionGenerator.Generate(root, "powershell");
    ...
    [Fact]
    public void Generate_PowerShell_ContainsAllGlobalOptions()
    {
        var root = BuildTestRootCommand();
        var script = ShellCompletionGenerator.Generate(root, "powershell");
    ...
    [Fact]
    public void Generate_PowerShell_ContainsSubcommands()
    {
        var root = BuildTestRootCommand();
        var script = ShellCompletionGenerator.Generate(root, "powershell");
    ...
    [Fact]
    public void Generate_PowerShell_ContainsStateSubcommands()
    {
        var root = BuildTestRootCommand();
        var script = ShellCompletionGenerator.Generate(root, "powershell");
    ...
    [Fact]
    public void Generate_Bash_ContainsCompleteCommand()
    {
        var root = BuildTestRootCommand();
        var script = ShellCompletionGenerator.Generate(root, "bash");
    ...
    [Fact]
    public void Generate_Bash_ContainsAllGlobalOptions()
    {
        var root = BuildTestRootCommand();
        var script = ShellCompletionGenerator.Generate(root, "bash");
    ...
    [Fact]
    public void Generate_Bash_ContainsContextAwareStateCompletions()
    {
        var root = BuildTestRootCommand();
        var script = ShellCompletionGenerator.Generate(root, "bash");

        // state subcommands should appear in the state context
        Assert.Contains("state)", script);
        Assert.Contains("list", script);
        Assert.Contains("backup", script);
        Assert.Contains("restore", script);
    ...
    [Fact]
    public void Generate_Bash_ContainsFilePathCompletion()
    {
        var root = BuildTestRootCommand();
        var script = ShellCompletionGenerator.Generate(root, "bash");
